            ...
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button disabled={credentials.name.length < 3 || !credentials.email.includes("@") || credentials.password !== credentials.cpassword || credentials.password.length < 6} type="submit" className="btn btn-primary btn-block my-2 signup--btn">Sign Up</button>
